...
log(Drinks$beer_servings) %>% hist(main = "Beer consumption in 2010")

## Transformation of spirits consumption
log(Drinks$spirit_servings) %>% hist(main = "Spirit consumption in 2010")

## Transformation of spirits consumption
log(Drinks$wine_servings) %>% hist(main = "Wine consumption in 2010")
