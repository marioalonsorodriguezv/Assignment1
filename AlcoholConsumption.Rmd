...
```{r Drinks, message=FALSE, warning=FALSE, echo=TRUE}
...
### A simple summary of descriptive statistics of all the dataset cool
summary(Drinks)
...
[Linktodiamonds](https://github.com/marioalonsorodriguezv/Assignment1/blob/master/Assignment1_Raju.R "Diamonds")
